...
for time in range(max_layer+1):
    current_layer = time
    if current_layer in firewall and scanner_at_zero(firewall[current_layer], time):
        severity += firewall[current_layer] * current_layer
