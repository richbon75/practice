...
def paths_from_place(visited, visited_score):
    ...
    for next_place in [place for place in legs[visited[-1]] if place not in visited]:
        ...
        if len(visited) == 8:
            ...
            if visited_score > longest_found_distance:
                print('New longest path found: ', visited, visited_score)
                longest_found_distance = visited_score
...
print('Shortest distance: ', shortest_found_distance)
print('Longest distance: ', longest_found_distance)
